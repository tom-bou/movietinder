...
function MoviePageView(props) {
  ...
  return (
    <div
      className="snap-y snap-mandatory lg:overflow-hidden h-screen w-screen bg-fixed animate-fade"
      style={{
    ...
    >
      ...
      <div className="navbar-swipe-buttons">
        ...
        <button
          ...
          className="text-3xl font-thin font-sans absolute right-3 md:right-11 top-7 lg:top-10"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
        ...
        <div className="lg:col-span-1 md:h-full grid grid-rows-3 ml-4 mr-4 md:mr-20">
          <div className="md:mt-32 grid grid-cols-2 ">
